    ...
    >
      ...
      >
        <div className={style.childwala}>
          ...
          <strong className={style.strongs}>
            {" "}
            A seamless experience that takes your style{" "}
          </strong>
          <strong className={style.strongs}> to the next level</strong>
          <br />

          <button className={style.buttons} onClick={onOpen}>
            {" "}
            DOWNLOAD NOW
          </button>
          <img
              ...
              <ModalBody>
                ...
                >
                  <div>
                    ...
                    >
                      Try Silver Premium For 3 Months
                    </h3>
                  </div>
                  ...
                  >
                    <img
                      ...
                      src="https://cdn.modesens.com/static/img/20190103ios_QR_code.png"
                      alt=""
                    />
                    <img
                      style={{
                      ...
                      src="https://cdn.modesens.com/static/img/20181229android_QR_code_global.png"
                      alt=""
                    />
                  </div>
                  <div
                    ...
                    <button
                      onClick={() =>
                        (window.location.href =
                          "https://apps.apple.com/app/id976201094")
                      }
                      style={{
                        margin: "10px",
