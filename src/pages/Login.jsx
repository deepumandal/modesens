...
const Login = ({ setLoginmouse, children }) => {
              ...
              <div className="innerone-div">
                <div className="index-login">
                  <img
                    ...
                    src="https://cdn.modesens.com/static/img/20220413whitelogo-assistant-en.svg"
                    alt=""
                  />
                      ...
                      <div>
                        ...
                        >
                          ...
                          <p style={{ fontSize: "14px" }}>
                            Compare across 500+ stores to find the best price.
                          </p>
                        </div>
                          ...
                          <div className="input-part">
                            ...
                            <div style={{ display: "flex" }}>
                              ...
                              <label htmlFor="check">
                                ...
                                >
                                  Subscribe to personalized sale updates and
                                  offers
                                </p>
                              </label>
                            </div>
